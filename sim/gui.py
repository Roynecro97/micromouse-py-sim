...
class GUIRenderer:  # pylint: disable=too-many-instance-attributes
    ...
    def draw_heatmap(self, info: ExtraCellInfo, cell_pos: Position, tile_size: int):
        ...
        if color:
            ...
            pg.draw.rect(alpha_surface, color, pg.Rect(cell_pos[0], cell_pos[1], tile_size, tile_size))
    ...
    def draw_robot(self, robot_pos: Position, robot_direction: Direction, tile_size: int):
        ...
        heading_point = robot_pos + Position(robot_radius * math.cos(robot_direction.to_radians()),
                                             robot_radius * math.sin(robot_direction.to_radians()))
